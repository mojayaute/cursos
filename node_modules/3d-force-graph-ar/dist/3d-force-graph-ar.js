...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ForceGraphAR = factory(global.THREE));
  ...
  var accessorFn = /*#__PURE__*/Object.freeze({
    __proto__: null,
    default: index$3
  });

  var require$$0 = /*@__PURE__*/getAugmentedNamespace(accessorFn);
...
`;
      ...
      keys.forEach(function (_ref, idx) {
        ...
        if (isProp) {
          var _itemVal = itemVal,
            ...
            rest = _objectWithoutProperties$2(_itemVal, [keyAccessor].map(_toPropertyKey$2));
          key = propVal;
          itemVal = rest;
        } else {
    ...
    methods: {
      ...
      tickFrame: function tickFrame(state) {
        ...
        function layoutTick() {
          ...
          var nodeThreeObjectExtendAccessor = index$3(state.nodeThreeObjectExtend);
  ...
  var threeForcegraph$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    default: threeForcegraph
  });

  var require$$1 = /*@__PURE__*/getAugmentedNamespace(threeForcegraph$1);

  /* global AFRAME */

  var hasRequiredAframeForcegraphComponent;

  function requireAframeForcegraphComponent () {
  	if (hasRequiredAframeForcegraphComponent) return aframeForcegraphComponent;
  	hasRequiredAframeForcegraphComponent = 1;
  	if (typeof AFRAME === 'undefined') {
  	  throw new Error('Component attempted to register before AFRAME was available.');
  	}

  	let accessorFn = require$$0;
  	if ('default' in accessorFn) {
  	  // unwrap default export
  	  accessorFn = accessorFn.default;
  	}

  	let ThreeForceGraph = require$$1;
  	...
  	AFRAME.registerComponent('forcegraph', {
  	  ...
  	  getGraphBbox: function(nodeFilterFn) {
  	    if (!this.forceGraph) {
  	...
  	return aframeForcegraphComponent;
  }

  requireAframeForcegraphComponent();

  //

  var _3dForceGraphAr = index$1({
    props: {
      width: {},
      height: {},
      yOffset: {
    ...
    methods: _objectSpread2$2(_objectSpread2$2({}, Object.assign.apply(Object, [{}].concat(_toConsumableArray$3(['getGraphBbox', 'emitParticle', 'd3Force', 'd3ReheatSimulation', 'refresh'].map(function (method) {
      return _defineProperty$2({}, method, function (state) {
    ...
    update: function update(state, changedProps) {
      ...
      changedProps.hasOwnProperty('glScale') && state.forcegraph.setAttribute('scale', _toConsumableArray$3(new Array(3)).map(function () {
      ...
      var newProps = Object.assign.apply(Object, [{}].concat(_toConsumableArray$3(Object.entries(state).filter(function (_ref5) {
      ...
      })), _toConsumableArray$3(Object.entries(state.graphData).map(function (_ref10) {
        var _ref11 = _slicedToArray$4(_ref10, 2),
          key = _ref11[0],
          val = _ref11[1];
        return _defineProperty$2({}, key, val);
      }))));
  ...
  return _3dForceGraphAr;

}));
//# sourceMappingURL=3d-force-graph-ar.js.map
